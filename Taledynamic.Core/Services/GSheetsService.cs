...
{
    public partial class GSheetsService : BaseService<GSheets>, IGSheetsService
    {
        private TaledynamicContext _context { get; }
        private IMongoCollection<TelegramJson> _documents { get; }

        public GSheetsService(TaledynamicContext context, IMongoDbSettings settings) : base(context)
        {
            _context = context;
