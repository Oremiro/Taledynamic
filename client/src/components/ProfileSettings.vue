<template>
    ...
    <n-form>
        ...
        <n-form-item label="Пароль" path="password.value">
            <template #label>
                <span>Пароль</span>
                <n-button style="margin-left: .4rem" text>
                    <n-icon size="16">
        ...
        <n-form-item v-if="false" label="Новый пароль" path="password.value">
            <n-input
                type="password"
                show-password-on="click"
                placeholder="" />
        </n-form-item>
        <n-form-item v-if="false" label="Повторите пароль" path="password.value">
            <n-input
                type="password"
                show-password-on="click"
                placeholder="" />
