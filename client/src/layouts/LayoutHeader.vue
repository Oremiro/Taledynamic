<template>
  <n-layout-header bordered style="padding: 0.3rem 3% 0.3rem 3%">
    <n-grid cols="12">
      <n-gi span="2">
        <div class="nav-logo">
      ...
      <n-gi span="2" offset="1">
        <div class="nav-extra">
          <n-button text style="margin-right: 1rem" @click="changeTheme">
            <n-icon size="23">
              <svg
          ...
          <n-button
            text
            tag="a"
            href="https://github.com/TaledynamicTeam/Taledynamic"
            target="_blank"
          >
            <n-icon size="22">
              <svg
